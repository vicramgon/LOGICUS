...
Para ejemplificar los conceptos expuestos a lo largo del tema vamos a modelar el mundo romano, $$LR = \{\underbrace{\boldsymbol{César}, \boldsymbol{Marco}}_{constantes}, \underbrace{P^{(1)}, L^{(2)}, O^{(2)}, R^{(1)}, IA^{(2)}}_{\textit{símbolos de predicado}}, \underbrace{f^{(1)}}_{\textit{símbolo de función}} \}$$ (los superíndices indican la aridad), de forma que son términos de $LR$:
...
<center> <img src="images/img4.png" title="Árbol de formación en LPO (ejemplo)."></center><br>
...
&gt; Func &quot;cesar&quot; []
<font color="#34E2E2">Func</font> <font color="#FCE94F">&quot;cesar&quot;</font> []<font color="#555753"> : Term</font>
&gt; Func &quot;marco&quot; []
<font color="#34E2E2">Func</font> <font color="#FCE94F">&quot;marco&quot;</font> []<font color="#555753"> : Term</font>
&gt; Var &quot;x&quot;
<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;x&quot;</font><font color="#555753"> : Term</font>
&gt; Var &quot;y&quot;
<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;y&quot;</font><font color="#555753"> : Term</font>
&gt; Var &quot;x_1&quot;
<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;x_1&quot;</font><font color="#555753"> : Term</font>
&gt; Func &quot;f&quot; [Func &quot;cesar&quot; []]
<font color="#34E2E2">Func</font> <font color="#FCE94F">&quot;f&quot;</font> [<font color="#34E2E2">Func</font> <font color="#FCE94F">&quot;cesar&quot;</font> []]<font color="#555753"> : Term</font>
&gt; Func &quot;f&quot; [Var &quot;x&quot;]
<font color="#34E2E2">Func</font> <font color="#FCE94F">&quot;f&quot;</font> [<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;x&quot;</font>]<font color="#555753"> : Term</font>
&gt; Func &quot;f&quot; [Func &quot;f&quot; [Var &quot;x&quot;]]
<font color="#34E2E2">Func</font> <font color="#FCE94F">&quot;f&quot;</font> [<font color="#34E2E2">Func</font> <font color="#FCE94F">&quot;f&quot;</font> [<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;x&quot;</font>]]
<font color="#555753">    : Term</font>
</pre>
...
&gt; Pred &quot;P&quot; [Func &quot;cesar&quot; []] |&gt; toStringFLPO 
<font color="#FCE94F">&quot;P (cesar)&quot;</font><font color="#555753"> : String</font>
&gt; Pred &quot;L&quot; [Func &quot;cesar&quot; [], Func &quot;marco&quot; []] |&gt; toStringFLPO 
<font color="#FCE94F">&quot;L (cesar, marco)&quot;</font><font color="#555753"> : String</font>
&gt; Pred &quot;IA&quot; [Func &quot;cesar&quot; [], Func &quot;f&quot;  [Var &quot;x&quot;]] |&gt; toStringFLPO 
<font color="#FCE94F">&quot;IA (cesar, f (x))&quot;</font><font color="#555753"> : String</font>
&gt; Forall (Var &quot;x&quot;) (Exists (Var &quot;y&quot;) (Pred &quot;L&quot; [Var &quot;x&quot;, Var &quot;y&quot;]))|&gt; toStringFLPO 
<font color="#FCE94F">&quot;∀x ∃y L (x, y)&quot;</font><font color="#555753"> : String</font>
&gt; f = fromStringToFLPO &quot;FORALL{x}(R[x;] IMPLIES (L[x;_cesar;] OR O[x; _cesar;]))&quot;
(<font color="#34E2E2">Just</font> (<font color="#34E2E2">Forall</font> (<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;x&quot;</font>) (<font color="#34E2E2">Impl</font> (<font color="#34E2E2">Pred</font> <font color="#FCE94F">&quot;R&quot;</font> [<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;x&quot;</font>]) (<font color="#34E2E2">Disj</font> (<font color="#34E2E2">Pred</font> <font color="#FCE94F">&quot;L&quot;</font> [<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;x&quot;</font>,<font color="#34E2E2">Func</font> <font color="#FCE94F">&quot;cesar&quot;</font> []]) (<font color="#34E2E2">Pred</font> <font color="#FCE94F">&quot;O&quot;</font> [<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;x&quot;</font>,<font color="#34E2E2">Func</font> <font color="#FCE94F">&quot;cesar&quot;</font> []])))),<font color="#FCE94F">&quot;&quot;</font>)
<font color="#555753">    : ( Maybe FormulaLPO, String )</font>
&gt; Forall (Var &quot;x&quot;) (Impl (Pred &quot;R&quot; [Var &quot;x&quot;]) (Disj (Pred &quot;L&quot; [Var &quot;x&quot;,Func &quot;cesar&quot; []]) (Pred &quot;O&quot; [Var &quot;x&quot;,Func &quot;cesar&quot; []]))) |&gt; toStringFLPO 
<font color="#FCE94F">&quot;∀x ( R (x) ⟶ ( L (x, cesar) ∨ O (x, cesar) ) )&quot;</font><font color="#555753"> : String</font>
</pre>
...
&gt; f = fromStringToFLPO &quot;FORALL{x}(R[x;] IMPLIES (L[x;_cesar;] OR O[x; _cesar;]))&quot;
(<font color="#34E2E2">Just</font> (<font color="#34E2E2">Forall</font> (<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;x&quot;</font>) (<font color="#34E2E2">Impl</font> (<font color="#34E2E2">Pred</font> <font color="#FCE94F">&quot;R&quot;</font> [<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;x&quot;</font>]) (<font color="#34E2E2">Disj</font> (<font color="#34E2E2">Pred</font> <font color="#FCE94F">&quot;L&quot;</font> [<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;x&quot;</font>,<font color="#34E2E2">Func</font> <font color="#FCE94F">&quot;cesar&quot;</font> []]) (<font color="#34E2E2">Pred</font> <font color="#FCE94F">&quot;O&quot;</font> [<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;x&quot;</font>,<font color="#34E2E2">Func</font> <font color="#FCE94F">&quot;cesar&quot;</font> []])))),<font color="#FCE94F">&quot;&quot;</font>)
<font color="#555753">    : ( Maybe Modules.SintaxSemanticsLPO.FormulaLPO, String )</font>
&gt; ejemplo = f |&gt; extractReadFLPO
<font color="#34E2E2">Forall</font> (<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;x&quot;</font>) (<font color="#34E2E2">Impl</font> (<font color="#34E2E2">Pred</font> <font color="#FCE94F">&quot;R&quot;</font> [<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;x&quot;</font>]) (<font color="#34E2E2">Disj</font> (<font color="#34E2E2">Pred</font> <font color="#FCE94F">&quot;L&quot;</font> [<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;x&quot;</font>,<font color="#34E2E2">Func</font> <font color="#FCE94F">&quot;cesar&quot;</font> []]) (<font color="#34E2E2">Pred</font> <font color="#FCE94F">&quot;O&quot;</font> [<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;x&quot;</font>,<font color="#34E2E2">Func</font> <font color="#FCE94F">&quot;cesar&quot;</font> []])))
<font color="#555753">    : Modules.SintaxSemanticsLPO.FormulaLPO</font>
&gt; toStringFLPO ejemplo
<font color="#FCE94F">&quot;∀x ( R (x) ⟶ ( L (x, cesar) ∨ O (x, cesar) ) )&quot;</font><font color="#555753"> : String</font>
</pre>
...
- Ejemplo 2 (tomando el lenguaje matemático), definamos la propiedad biyectiva. Para expresarla consideremos el siguiente lenguaje: $L= \{O, I, f\}$, tal que:
    ...
    <font color="#555753">--------------------------------------------------------------------------------</font>
    &gt; import Modules.IO_LPO exposing (..)
    &gt; fbiy = fromStringToFLPO &quot;FORALL{x} FORALL{y} (O[x;] AND O[y;] AND NOT (x=y) IMPLIES NOT (_f[x;]=_f[y;])) AND FORALL{x}(I[x;] IMPLIES EXISTS{y}(O[y;] AND _f[y;]=x))&quot; 
    (<font color="#34E2E2">Just</font> (<font color="#34E2E2">Conj</font> (<font color="#34E2E2">Forall</font> (<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;x&quot;</font>) (<font color="#34E2E2">Forall</font> (<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;y&quot;</font>) (<font color="#34E2E2">Impl</font> (<font color="#34E2E2">Conj</font> (<font color="#34E2E2">Pred</font> <font color="#FCE94F">&quot;O&quot;</font> [<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;x&quot;</font>]) (<font color="#34E2E2">Conj</font> (<font color="#34E2E2">Pred</font> <font color="#FCE94F">&quot;O&quot;</font> [<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;y&quot;</font>]) (<font color="#34E2E2">Neg</font> (<font color="#34E2E2">Equal</font> (<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;x&quot;</font>) (<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;y&quot;</font>))))) (<font color="#34E2E2">Neg</font> (<font color="#34E2E2">Equal</font> (<font color="#34E2E2">Func</font> <font color="#FCE94F">&quot;f&quot;</font> [<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;x&quot;</font>]) (<font color="#34E2E2">Func</font> <font color="#FCE94F">&quot;f&quot;</font> [<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;y&quot;</font>])))))) (<font color="#34E2E2">Forall</font> (<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;x&quot;</font>) (<font color="#34E2E2">Impl</font> (<font color="#34E2E2">Pred</font> <font color="#FCE94F">&quot;I&quot;</font> [<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;x&quot;</font>]) (<font color="#34E2E2">Exists</font> (<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;y&quot;</font>) (<font color="#34E2E2">Conj</font> (<font color="#34E2E2">Pred</font> <font color="#FCE94F">&quot;O&quot;</font> [<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;y&quot;</font>]) (<font color="#34E2E2">Equal</font> (<font color="#34E2E2">Func</font> <font color="#FCE94F">&quot;f&quot;</font> [<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;y&quot;</font>]) (<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;x&quot;</font>))))))),<font color="#FCE94F">&quot;&quot;</font>)
    <font color="#555753">    : ( Maybe Modules.SintaxSemanticsLPO.FormulaLPO, String )</font>
    &gt; f = extractReadFLPO fbiy
    <font color="#34E2E2">Conj</font> (<font color="#34E2E2">Forall</font> (<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;x&quot;</font>) (<font color="#34E2E2">Forall</font> (<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;y&quot;</font>) (<font color="#34E2E2">Impl</font> (<font color="#34E2E2">Conj</font> (<font color="#34E2E2">Pred</font> <font color="#FCE94F">&quot;O&quot;</font> [<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;x&quot;</font>]) (<font color="#34E2E2">Conj</font> (<font color="#34E2E2">Pred</font> <font color="#FCE94F">&quot;O&quot;</font> [<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;y&quot;</font>]) (<font color="#34E2E2">Neg</font> (<font color="#34E2E2">Equal</font> (<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;x&quot;</font>) (<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;y&quot;</font>))))) (<font color="#34E2E2">Neg</font> (<font color="#34E2E2">Equal</font> (<font color="#34E2E2">Func</font> <font color="#FCE94F">&quot;f&quot;</font> [<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;x&quot;</font>]) (<font color="#34E2E2">Func</font> <font color="#FCE94F">&quot;f&quot;</font> [<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;y&quot;</font>])))))) (<font color="#34E2E2">Forall</font> (<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;x&quot;</font>) (<font color="#34E2E2">Impl</font> (<font color="#34E2E2">Pred</font> <font color="#FCE94F">&quot;I&quot;</font> [<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;x&quot;</font>]) (<font color="#34E2E2">Exists</font> (<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;y&quot;</font>) (<font color="#34E2E2">Conj</font> (<font color="#34E2E2">Pred</font> <font color="#FCE94F">&quot;O&quot;</font> [<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;y&quot;</font>]) (<font color="#34E2E2">Equal</font> (<font color="#34E2E2">Func</font> <font color="#FCE94F">&quot;f&quot;</font> [<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;y&quot;</font>]) (<font color="#34E2E2">Var</font> <font color="#FCE94F">&quot;x&quot;</font>))))))
    <font color="#555753">    : Modules.SintaxSemanticsLPO.FormulaLPO</font>
    &gt; toStringFLPO f
    <font color="#FCE94F">&quot;( ∀x ∀y ( ( O (x) ∧ ( O (y) ∧ ¬ (x = y) ) ) ⟶ ¬ (f (x) = f (y)) ) ∧ ∀x ( I (x) ⟶ ∃y ( O (y) ∧ (f (y) = x) ) ) )&quot;</font>
    <font color="#555753">    : String</font>
    &gt; 
    </pre>
...
<font color="#555753">    : Modules.SintaxSemanticsLPO.FormulaLPO</font>
&gt; formTree f
<font color="#FCE94F">&quot;digraph G {\n  rankdir=TB\n  graph []\n  node [shape=plaintext, color=black]\n  edge [dir=none]\n\n  0 -&gt; 1\n  1 -&gt; 2\n  1 -&gt; 3\n  3 -&gt; 4\n  3 -&gt; 5\n\n  0 [label=\&quot;∀x ( R (x) ⟶ ( L (x, cesar) ∨ O (x, cesar) ) )\&quot;]\n  1 [label=\&quot;( R (x) ⟶ ( L (x, cesar) ∨ O (x, cesar) ) )\&quot;]\n  2 [label=\&quot;R (x)\&quot;]\n  3 [label=\&quot;( L (x, cesar) ∨ O (x, cesar) )\&quot;]\n  4 [label=\&quot;L (x, cesar)\&quot;]\n  5 [label=\&quot;O (x, cesar)\&quot;]\n}&quot;</font>
<font color="#555753">    : String</font>
</pre>

<center> <img src="images/img5.png" title="AF en LPO con Logicus (ejemplo)."></center><br>

##### Tratamiento de la cuantificación.
